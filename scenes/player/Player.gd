...
export (int) var MISSILE_BULLET_SPEED = 100
...
onready var fireMissileTimer = $FireMissileTimer
...
func _physics_process(delta):
	...
	if Input.is_action_pressed("fire_missile") and fireMissileTimer.time_left == 0:
...
func fire_missile():
	...
	Events.emit_signal("add_screenshake", 0.2, 0.2)
	fireMissileTimer.start()
